...
public class Maze {
	...
	public Maze(String filePath) throws FileNotFoundException {
		...
		int rows = Integer.parseInt(in.nextLine());//kolko reda ima
		this.maze = new int[rows][];

		for (int i = 0; i < rows; i++) { //prochita se vseki red i se razdelq na ", "
			String line = in.nextLine();
			String[] numbers = line.split(", ");
			this.maze[i] = new int[numbers.length];//masiva na reda - 
